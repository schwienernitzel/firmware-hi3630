...
backup_folder_max_num      16        //powerlog backup max folder number;max_limit_value is 10*5
file_max_size	           15        //unit: Mbytes, max size of the wakelocks-log,to compress powerlog when log size is more than the threshold. max_limit_value is 10*5
